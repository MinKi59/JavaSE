...
public class JavaLang05 {
	...
	public static void main(String[] args) {
		...
		// 문자열 절삭
		String str9 = "abcDEF";
		String substring = str9.substring(0, 2); // '0'번째부터 '2'글자
		System.out.println("substring: " + substring);
		
		// 소문자 변환 -> 원래 값을 바꾸는 게 아님!!
		String str10 = "abcDEF";
		String toLowerCase = str10.toLowerCase();
		System.out.println("toLowerCase: " + toLowerCase);

		// 대문자 변환 -> 원래 값을 바꾸는 게 아님!!
		String str11 = "abcDEF";
		String toUpperCase = str11.toUpperCase();
		System.out.println("toUpperCase: " + toUpperCase);
		
		// 공백제거 -> 맨 앞, 맨 뒤 공백을 제거함(중간 공백은 제거 X)
		...
		// 문자비교 -> 같으면 0, 다르면 0이 아닌 값(앞 값(str14) - 뒷 값(str15))
		String str14 = "A";
		String str15 = "B";
