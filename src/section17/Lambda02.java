...
public class Lambda02 {
	...
	public static void main(String[] args) {
		...
		List<String> list1 = List.of("Apple", "Bat", "Cat", "Dog"); // 값 변경 X
		List<String> list2 = Arrays.asList("Apple", "Bat", "Cat", "Dog"); // 값 변경 O
		
		printBasic(list1);
		printBasic(list2);
		printWithFP(list1);
		printBasicWithFiltering(list1);
		printWithFpFiltering(list1);
	}
